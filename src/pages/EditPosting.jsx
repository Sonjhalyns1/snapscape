  ...
  return (
    <div className='h-screen w-full bg-[#32383D]'>
        <main className='max-w-md px-2 mx-auto'>
            <h6 className='text-2xl text-center p-6 font weight-bold'>Edit Posting</h6>
            <form onSubmit={onSubmit}>
                ...
                <button type= "submit" className=' mt-2 mb-6 w-full px-7 py-3 bg-blue-600 text-white font-medium text-sm uppercase rounded shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out'>Edit Posting</button>
            </form>
        </main>
