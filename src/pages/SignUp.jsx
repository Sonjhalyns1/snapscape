...
export default function SignUp() {
  ...
  return (
    ...
    <section className=''> 
      ...
      <h5 className='text-3xl p-4 text-center text-bold'> <span>Sign Up</span></h5>
      <div className='flex justify-center flex-wrap items-center px-6 py-12 max-w-6xl mx-auto'>
        <div className='md:w-[67%] lg:w-[50%] mb-12 md:mb-6'>
          <img src = "https://image.cnbcfm.com/api/v1/image/103186325-GettyImages-485001492.jpg?v=1550601747" alt="key" className='w-full rounded-2xl'/>
        ...
        <div className='w-full md:w-[67%] lg:w-[40%] lg:ml-20'>
          ...
          <input  type='text' id= "name" value={name} onChange={onChange} placeholder='Full name' className='w-full px-4 py-2 text-xl text-gray-700 bg-white border-gray-300 rounded transition ease-in-out mb-6'/>
            ...
            <div className='flex justify-between whitespace-nowrap text-sm sm:text-lg'>
              <p className='mb-6'> Have in account?
