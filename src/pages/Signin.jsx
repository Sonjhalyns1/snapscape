...
export default function Signin() {
  ...
  return (
    ...
    <section className=''> 
      ...
      <h5 className='text-3xl p-4 text-center text-bold'> <span>Sign In</span></h5>
      <div className='flex justify-center flex-wrap items-center px-6 py-12 max-w-6xl mx-auto'>
        <div className='md:w-[67%] lg:w-[50%] mb-12 md:mb-6'>
          <img src = "https://images.unsplash.com/photo-1634224143538-ce0221abf732?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1374&q=80" alt="key" className='w-full rounded-2xl'/>
